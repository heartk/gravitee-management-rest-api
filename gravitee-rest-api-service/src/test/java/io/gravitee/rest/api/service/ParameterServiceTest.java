...
public class ParameterServiceTest {
    ...
    public void shouldFindAll() throws TechnicalException {
        ...
        final List<String> values = parameterService.findAllEnv(PORTAL_TOP_APIS);
    ...
    public void shouldFindAllFromEnvVar() throws TechnicalException {
        ...
        final List<String> values = parameterService.findAllEnv(API_LABELS_DICTIONARY);
    ...
    public void shouldFindAllWithFilter() throws TechnicalException {
        ...
        final List<String> values = parameterService.findAllEnv(PORTAL_TOP_APIS, value -> value, value -> !value.isEmpty());
    ...
    public void shouldFindAllWithFilterFromEnvVar() throws TechnicalException {
        ...
        final List<String> values = parameterService.findAllEnv(API_LABELS_DICTIONARY, value -> value, value -> !value.isEmpty());
    ...
    public void shouldFindAllKeysWithFilter() throws TechnicalException {
        ...
        final Map<String, List<String>> values = parameterService.findAllEnv(Arrays.asList(p1key, p2key, p3key), value -> value, value -> !value.isEmpty());
    ...
    public void shouldFindAllKeysWithFilterFromEnvVar() throws TechnicalException {
        ...
        final Map<String, List<String>> values = parameterService.findAllEnv(Arrays.asList(p1key, p2key, p3key, p4key), value -> value, value -> !value.isEmpty());
    ...
    public void shouldCreate() throws TechnicalException {
        ...
        Parameter result = parameterService.saveEnv(PORTAL_TOP_APIS, "api1");
    ...
    public void shouldCreateList() throws TechnicalException {
        ...
        Parameter result = parameterService.saveEnv(PORTAL_TOP_APIS, "api1;api2");
    ...
    public void shouldNotCreateOrUpdateIfEnvVar() throws TechnicalException {
        ...
        Parameter result = parameterService.saveEnv(API_LABELS_DICTIONARY, "api1");
    ...
    public void shouldUpdate() throws TechnicalException {
        ...
        parameterService.saveEnv(PORTAL_TOP_APIS, "api2");
    ...
    public void shouldCreateMultipleValue() throws TechnicalException {
        ...
        parameterService.saveEnv(PORTAL_TOP_APIS, Collections.singletonList("api1"));
    ...
    public void shouldUpdateMultipleValue() throws TechnicalException {
        ...
        parameterService.saveEnv(PORTAL_TOP_APIS, asList("api1", "api2", "api2"));
    ...
    public void shouldFindAsBoolean() throws TechnicalException {
        ...
        assertTrue(parameterService.findEnvAsBoolean(PORTAL_RATING_ENABLED));
    }
    ...
    public void shouldFindAsBooleanDefaultValue() throws TechnicalException {
        ...
        assertTrue(parameterService.findEnvAsBoolean(PORTAL_USERCREATION_ENABLED));
    }
    ...
    public void shouldFind() throws TechnicalException {
        ...
        assertEquals(parameter.getValue(), parameterService.findEnv(COMPANY_NAME));
    }
    ...
    public void shouldFindList() throws TechnicalException {
        ...
        assertEquals(parameter.getValue(), parameterService.findOrg(API_LABELS_DICTIONARY));
    }
    ...
    public void shouldFindFromEnvVar() throws TechnicalException {
        ...
        assertEquals(companyName, parameterService.findEnv(COMPANY_NAME));
    ...
    public void shouldFindListFromEnvVar() throws TechnicalException {
        ...
        assertEquals("label1;label2", parameterService.findEnv(API_LABELS_DICTIONARY));
