...
public class ApiMapperTest {
    ...
    public void testConvert() {
        ...
        doReturn(true).when(parameterService).findEnvAsBoolean(Key.PORTAL_APIS_CATEGORY_ENABLED);
    ...
    public void testMinimalConvert() {
        ...
        apiEntity.setCategories(new HashSet<>(Arrays.asList(API_CATEGORY, API_CATEGORY_HIDDEN)));
        doReturn(false).when(parameterService).findEnvAsBoolean(Key.PORTAL_APIS_CATEGORY_ENABLED);
